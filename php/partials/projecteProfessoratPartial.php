...
<div id="contingut" class="mx-auto text-md-center text-left">
        <form id="form_36249" class="appnitro mx-auto text-md-center text-left" action="processaProjecteProfessorat.php" method="POST" enctype="multipart/form-data">
                ...
                <ul>
                        ...
                        <li class="form-group mx-auto text-md-center text-left">
                                <label class="description" for="element_5">Nom alumnat </label>
                                <div>
                                        <input id="element_5" name="nomalum" class="element text medium" type="text" maxlength="255" value="" required />
                                </div>
                        </li>
                        <li class="form-group mx-auto text-md-center text-left">
                                <label class="description" for="element_6">Cognoms alumnat
                                </label>
                                <div>
                                        <input id="element_6" name="cognomalum" class="element text medium" type="text" maxlength="255" value="" required />
                                </div>
                        </li>
                        <li class="form-group mx-auto text-md-center text-left">
                                <label class="description" for="element_6">Email alumnat
                                </label>
                                <div>
                                        <input id="element_6" name="emailalum" " class="element text medium" type="email" required />
                                </div>
                        </li>

                        <li class="form-group mx-auto text-md-center text-left">
                                <label class="description" for="element_6">Població alumnat
                                </label>
                                <div>
                                        <input id="element_6" name="poblacioalum" " class="element text medium" type="text" required />
                                </div>
                        </li>
